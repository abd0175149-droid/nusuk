                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <tr v-for="a in filteredAgents" :key="a.id" class="border-t border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-800/30">
                            ...
                            <td class="px-5 py-3 font-bold font-mono" dir="ltr" :class="parseFloat(a.balance_sar)>=0?'text-green-600':'text-red-600'">{{ Number(a.balance_sar).toLocaleString('en',{minimumFractionDigits:2}) }} {{ a.currency||'SAR' }}</td>
