                ...
                <table class="w-full text-sm responsive-table">
                    ...
                    <tbody>
                        <tr v-for="e in entries" :key="e.id" class="border-t border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-800/30">
                            ...
                            <td data-label="الرصيد" class="px-4 py-3 text-right font-mono text-xs font-bold" dir="ltr" :class="parseFloat(e.balance_after)>=0?'text-green-500':'text-red-500'">{{ Number(e.balance_after).toFixed(2) }}</td>
